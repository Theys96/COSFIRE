...
stats = np.loadtxt('comparison5.csv', delimiter=',', skiprows=1)
...
ax1.axis([1,32,0,1600])
ax1.set_xlabel('#Threads')
ax1.set_ylabel('Time (ms)')
ax1.grid(True, 'major', 'y')
ax1.legend(('21 tuples','17 tuples','13 tuples','9 tuples','5 tuples'))
#plt.show()
plt.savefig('comparison5.pdf')




stats = np.loadtxt('comparison6.csv', delimiter=',', skiprows=1)
